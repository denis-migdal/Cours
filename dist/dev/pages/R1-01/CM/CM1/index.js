    ...
    if (tokens.length === 1) {
        ...
        if (tokens[0].type === "range") {
            return new Node((sheet)=>{
                //TODO: if formula too...
                return sheet.getCells(tokens[0].value).cells[0].rawContent;
            });
        }
        throw new Error("???");
    }
